      ...
      <div className="question-container">
        <div className="unit">
          ...
          <div className="answers">
            ...
            <p>a 1889</p>
            <input type="radio" name="q1" onChange={handleChange2} />{" "}
            <p>b 1901</p>
            <input type="radio" name="q1" onChange={handleChange2} />{" "}
            <p>c 1915</p>
          </div>
        ...
        <div className="unit">
          ...
          <div className="answers">
            <input type="radio" name="q2" onChange={handleChange2} />{" "}
            <p>a Spanien</p>
        ...
        <div className="unit">
          ...
          <div className="answers">
            ...
            <input type="radio" name="q3" onChange={handleChange2} />{" "}
            <p>b Roald Dahl</p>
            <input type="radio" name="q3" onChange={handleChange2} />{" "}
            <p>c J.K. Rowling</p>
          </div>
        ...
        <div className="unit">
          ...
          <div className="answers">
            ...
            <p>a 1939</p>
            <input type="radio" name="q5" onChange={handleChange2} />{" "}
            <p>b 1941</p>
            <input type="radio" name="q5" onChange={handleChange2} />{" "}
            <p>c 1945</p>
          </div>
